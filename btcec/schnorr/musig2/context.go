...
type contextOptions struct {
	// tweaks is the set of optinoal tweaks to apply to
	tweaks []KeyTweakDesc

	// taprootTweak specifies the taproot tweak. If speciied, then we'll
	...
	// use it as the internal key. This is requried as the taproot tweak
